...
//					}
	...
	const string GROUP_KEY = "balbalbalbal";
...
//		IntPtr msgPointer = AndroidJNIHelper.ConvertToJNIArray (message);
//		jvalue[] val = new jvalue[1];
//		val [0].l = msgPointer;

		object[] msgParam = new object[14];
		msgParam [0] = id;
		...
		if (pluginClass != null) {
//			pluginClass.CallStatic ("SetNotification", id, delay * 1000L, title, summary, message, sound ? 1 : 0, vibrate ? 1 : 0, 
//				lights ? 1 : 0, bigIcon, "notify_icon_small", bgColor.r * 65536 + bgColor.g * 256 + bgColor.b, (int)executeMode, mainActivityClassName);
